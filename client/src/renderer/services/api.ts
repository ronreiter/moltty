...
export const CODING_TOOLS: { id: CodingTool; name: string; command: string; description: string }[] = [
  { id: 'claude', name: 'Claude Code', command: 'claude', description: 'Anthropic' },
  { id: 'opencode', name: 'OpenCode', command: 'opencode', description: 'Open source' },
  { id: 'gemini', name: 'Gemini CLI', command: 'gemini', description: 'Google' },
  ...
  { id: 'amp', name: 'Amp', command: 'amp', description: 'Sourcegraph' },
]
