...
export default function GoogleLoginButton({ onTokens }: Props) {
  ...
  return (
    <button
      onClick={handleClick}
      className="w-full py-3 border border-terminal-border rounded-lg text-terminal-text hover:bg-terminal-bg transition-colors flex items-center justify-center gap-2"
    >
